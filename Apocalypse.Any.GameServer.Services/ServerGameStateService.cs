...
namespace Apocalypse.Any.GameServer.Services
{
        ...
        where TWorld : class, IWorldGameStateDataIOLayer, IWorldGameSectorInputLayer
    {
        ...
        private void LoadDefaultGameStates()
        {
            ...
            InternalGameStates.GetOrAdd((byte)ServerInternalGameStates.SendPressedRelease, new SendPressedReleaseCommandGameState<TWorld>(new NetworkCommandDataConverterService(SerializationAdapter), new IntToPressReleaseCommandTranslator()));
