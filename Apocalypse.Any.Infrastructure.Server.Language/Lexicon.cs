...
namespace Apocalypse.Any.Infrastructure.Server.Language
{
    public class Lexicon
    {
        ...
        public readonly List<char> Positon = "Position".ToList();
        ...
        public readonly List<char> FactionIdentifier = ".".ToList();
        public readonly List<char> FunctionIdentifier = ":".ToList();
        public readonly List<char> MilisecondsAttribute = "Miliseconds".ToList();
        ...
        private Dictionary<List<char>,LexiconSymbol> SymbolTable = new Dictionary<List<char>, LexiconSymbol>();
        ...
        private void InitializeSymbolTable()
        {
            ...
            //SymbolTable.Add(ModifyPositon,LexiconSymbol.ModifyAtttribute); // yeah. lets see what happens

            SymbolTable.Add(Scale,LexiconSymbol.Scale);
            SymbolTable.Add(Positon,LexiconSymbol.Position);
            ...
            SymbolTable.Add(FactionIdentifier,LexiconSymbol.FactionIdentifier);
            ...
            SymbolTable.Add(MilisecondsAttribute,LexiconSymbol.Miliseconds);
