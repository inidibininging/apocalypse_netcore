...
namespace Apocalypse.Any.Client.GameObjects.Scene
{
    public class RandomDebrisField :
        ...
        IVisualGameObject
    {
        public RandomDebrisField(int debrisCount = 100)
        {
        ...
        public List<RandomDebris> RandomDebris { get; set; } = new();
        ...
        public void Add(float x, float y, Color color, float scale = 0.5f)
        {
            ...
            Sheet.SpriteSheetRectangle.Add((RandomDebris.Count, 0, 0),
                new Rectangle(droppedJunk.FramePosition.ToPoint(), new Point(32)));
        }
    }
}