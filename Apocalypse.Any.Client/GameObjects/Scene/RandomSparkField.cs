...
namespace Apocalypse.Any.Client.GameObjects.Scene
{
    public class RandomSparkField :
        ...
        IVisualGameObject
    {
        public RandomSparkField(int sparksCount = 100)
        {
        ...
        public List<RandomSpark> RandomSparks { get; set; } = new();
        ...
        public void Add(float x, float y, Color color, float scale = 0.5f,
            float layerDepth = DrawingPlainOrder.EntitiesFX)
        {
            ...
            Sheet.SpriteSheetRectangle.Add((RandomSparks.Count, 0, 0),
                new Rectangle(spark.FramePosition.ToPoint(), new Point(32)));
        }
    }
}