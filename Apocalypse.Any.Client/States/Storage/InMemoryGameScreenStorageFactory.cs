...
namespace Apocalypse.Any.Client.States.Storage
{
    ...
    {
        public IStateMachine<string, INetworkGameScreen> BuildClientStateMachine(
            GameClientConfiguration gameClientConfiguration)
        {
            ...
            var serializer =
                Activator.CreateInstance(gameClientConfiguration.SerializationAdapterType.LoadType(true, false)[0]) as
                    IByteArraySerializationAdapter;

            inMemoryStorage.Add(ClientGameScreenBook.CheckLoginSent, new CheckLoginSentState());
            inMemoryStorage.Add(ClientGameScreenBook.CreateFetchDataIfNotExists,
                new CommandStateStateDelegate<string, INetworkGameScreen>(machine =>
                {
                    try
                    {
            ...
            inMemoryStorage.Add("BuildConfig",
                new CommandStateActionDelegate<string, INetworkGameScreen>(machine =>
                {
                    machine.SharedContext.Configuration = gameClientConfiguration;
                }));

            inMemoryStorage.Add(ClientGameScreenBook.FillWithDefaultServerDataState,
                new FillWithDefaultServerDataState());
            ...
            inMemoryStorage.Add(ClientGameScreenBook.BuildGameSheetFrames,
            ...
            inMemoryStorage.Add("UpdateLogoPosition", new CommandStateActionDelegate<string, INetworkGameScreen>(
                machine =>
                {
            ...
            inMemoryStorage.Add("UpdateGameOverPosition", new CommandStateActionDelegate<string, INetworkGameScreen>(
                machine =>
                {
                    if (machine.SharedContext.LastMetadataBag == null)
                        return;
                    ...
                    var hideGameOver = machine.SharedContext.LastMetadataBag.Stats.Health >
                                       machine.SharedContext.LastMetadataBag.Stats.GetMinAttributeValue();
            ...
            inMemoryStorage.Add("UpdateBackground", new CommandStateActionDelegate<string, INetworkGameScreen>(
                machine =>
                {
                    foreach (var starToMove in machine.SharedContext
                        ...
                        try
                        {
                            ...
                            starToMove.Position.X = ScreenService.Instance.DefaultScreenCamera.Position.X +
                                                    Randomness.Instance.From(0,
                                                        (int) ScreenService.Instance.Resolution.X) *
                                                    ScreenService.Instance.DefaultScreenCamera.Zoom * directionX;
                            starToMove.Position.Y = ScreenService.Instance.DefaultScreenCamera.Position.Y +
                                                    Randomness.Instance.From(0,
                                                        (int) ScreenService.Instance.Resolution.Y) *
                                                    ScreenService.Instance.DefaultScreenCamera.Zoom * directionY;
                        }
                        catch (Exception)
                        {
                        }
            ...
            inMemoryStorage.Add(nameof(NetworkInterpolationState),
                new NetworkInterpolationState(new DeltaGameStateDataService()));
            ...
            inMemoryStorage.Add(ClientGameScreenBook.SendGameStateUpdateData,
                new SendGameStateUpdateDataState(serializer));
            ...
            inMemoryStorage.Add(ClientGameScreenBook.BuildInventoryWindow,
                new BuildInventoryWindowState(dummyHudSheetToChangeInTheFuture));
            ...
            inMemoryStorage.Add(ClientGameScreenBook.UpdateInventoryImages,
                new UpdateInventoryImagesState(new PlayerInventoryDrawingFactory()));
            ...
            inMemoryStorage.Add(ClientGameScreenBook.BuildInfoWindow,
                new BuildInfoWindowState(dummyHudSheetToChangeInTheFuture));
