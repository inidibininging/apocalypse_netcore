...
namespace Apocalypse.Any.Infrastructure.Common.Services.Serializer.ZeroFormatterAdapter
{
    public class ZeroFormatterSerializerAdapter : ISerializationAdapter
    {
