        ...
        public void Handle(IStateMachine<string, IGameSectorLayerService> machine)
        {
            if(HandleOnce)
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    ...
                    var firstAppearingDynamicRelationLayer = machine.SharedContext
                                                            .DataLayer
                                                            .Layers
                                                            .FirstOrDefault(circularLocationList => circularLocationList.GetValidTypes().Any(t => t == typeof(DynamicRelation)));

                    if (firstAppearingCircularLocationListLayer == null ||
                        firstAppearingDynamicRelationLayer == null)
                        return;
                    ...
                    .ForEach(newLocation =>
                    {
                        ...
                        firstAppearingDynamicRelationLayer.Add(new DynamicRelation()
                        {
